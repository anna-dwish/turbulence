...
moment.2.mod.glm <- glm(log(R_moment_2) ~ Sv + Re + St + St_2, data = turbulence)
...
moment.4.mod <- glm(log(R_moment_4) ~ Re + Sv + St + Re*Sv + Re*St + Sv*St, data=turbulence)
round(cv.glm(turbulence, moment.4.mod)$delta[1],3)
pander(moment.4.mod, caption="Moment 4")
```

*Is it okay to have a only main effect intrxn even if squared main effect?*
