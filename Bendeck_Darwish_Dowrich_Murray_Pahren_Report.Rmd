...
One of the greatest areas of research in Physics today is the study of fluid motion [[1]][Bibliography]. The applications of these investigations span across the aviation industry, astrophysics, oil spills in oceans, and more [[1]][Bibliography]. Turbulence is defined to be "chaotic changes in pressure and flow velocity" [[2]][Bibliography]. For this case study, we will be exploring models to better understand and predict particle volume cluster under homogenous isotropic turbulence.
