...
m3_full_preds_df = m3_full_preds_df %>% dplyr::select(c("Sv", "Sv_2", "Re", "fit", "lwr", "upr"))
colnames(m3_full_preds_df) = c("Sv", "Sv_2", "Re", "pred", "95% low pred", "95% high pred")
m3_preds_of_interest = m3_full_preds_df[c(6, 21, 4, 14),]
