...
For this model, interaction effects lent to higher estimated test errors and were not significant in terms of their p-values. For this reason, there are no interaction effects in our final model for predicting the log of the 3rd moment. From the model output, we see that as the Reynold's number increases, we expect the log of the third moment of our response to decrease. This suggests the "lopsidedness" of the distribution of the log of the 3rd moment decreases the ratio between fluid velocity and body size increases [[3]][Bibliography]. Finally, there appears to be an increasing relationship in the log of the third moment and the *linear* effect of the settling parameter and a decreasing relationship with the *quadratic* effect of the settlign parameter. This suggests that there is a leveling off of the effect of the settling parameter as it increases.
